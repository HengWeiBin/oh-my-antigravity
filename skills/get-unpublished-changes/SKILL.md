...
| Layer | Scope / Files | Release Note Guidance |
|---|---|---|
| `antigravity core` | MCP packages, `skills/`, reusable scripts | Do shared components need a patch/minor/major release note? |
| `antigravity plugin` | Root `oh-my-antigravity`, CLI, config, hooks, tools, docs | What semver bump should the oh-my-antigravity npm package use? |

## Steps:
1. Detect latest published version for `oh-my-antigravity`.
...
Include:
- `Layered Impact Matrix`: rows for `antigravity core`, `antigravity plugin`
